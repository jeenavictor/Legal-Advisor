...
if(request.getParameter("add")!= null)
{
   ...
   <script>
   alert("already exist");
   window.location="court_register.jsp";
   </script>
   <%
   }
   else
   ...
   st1.executeUpdate("insert into court values(null,(select max(logid) from login),'"+fname+"','"+pl+"','"+pin+"','"+phone+"','"+email+"')");
...
<form method="post">
    <h1 align="center" style="color: white">  Court Registration </h1>
